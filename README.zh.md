...
```bash
git clone --branch v0.1.5 https://github.com/dmnbme/agent-team-sync ~/.team-sync/pkg   # 成员
pip install --user "agent-team-sync @ git+https://github.com/dmnbme/agent-team-sync@v0.1.5"  # 或:维护者,得到 team-sync 命令
```
